...
export class ConnectionForm {
  ...
  private renderGitHubLoginButton(): void {
    ...
    placeholder.innerHTML = `
      <button id="github-login-btn" class="github-login-btn text-[11px] font-bold tracking-[0.1em] text-[#bbccb0] hover:text-[#4af626] transition-all cursor-pointer flex items-center gap-1.5 bg-transparent border border-[#3c4b36] px-3 py-1 hover:border-[#4af626]">
